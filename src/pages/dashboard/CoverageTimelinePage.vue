...
<template>
  <main class="max-w-6xl mx-auto px-4 py-8 pb-12">
    ...
    <div class="flex items-start gap-4 mb-8">
      ...
      <div>
        <h1 class="text-xl font-bold tracking-tight" style="color:#031a60">Coverage Timeline</h1>
        <p class="text-sm mt-0.5" style="color:#a8adc1">Month-by-month view of your covered rent periods</p>
    ...
    <div class="flex items-center gap-2 font-semibold mb-3" style="color:#031a60">
      ...
      {{ selectedYear === 'All' ? 'All Covered Months' : `Covered Months — ${selectedYear}` }}
      <span class="ml-auto text-xs font-normal px-2 py-0.5 rounded-full"
    ...
    <div class="flex items-center gap-2 mt-2 text-xs" style="color:#a8adc1">
      ...
      Last covered month: <strong style="color:#031a60">{{ monthToLongLabel(lastMonth) }}</strong>
    </div>
