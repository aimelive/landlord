...
<template>
  <div>
    <!-- Welcome banner -->
    <div
      class="relative overflow-hidden rounded-2xl px-6 py-5 mb-8"
      style="
    ...
    >
      <div
        class="absolute -top-10 -right-10 w-48 h-48 rounded-full pointer-events-none"
        style="
          background: radial-gradient(
            circle,
            rgba(41, 159, 77, 0.2) 0%,
            transparent 70%
          );
        "
      ></div>
      <div
        class="absolute bottom-0 left-1/2 w-64 h-32 pointer-events-none"
        style="
          background: radial-gradient(
            circle,
            rgba(91, 138, 245, 0.12) 0%,
            transparent 70%
          );
        "
      ></div>
      ...
      >
        <div>
          ...
          <p class="text-sm mt-1" style="color: rgba(255, 255, 255, 0.6)">
            Your rent coverage is up to date · Last covered
            {{ monthToLongLabel(lastMonth) }}
          </p>
        </div>
        <div
          class="flex flex-col items-center px-4 py-2.5 rounded-xl"
        ...
        >
          ...
          <span
            ...
            >Credit Score</span
          >
          <span class="text-xs font-semibold mt-0.5" style="color: #4fd87c"
            >Excellent</span
          >
        </div>
      </div>
    ...
    <!-- Page heading -->
    <div class="mb-6">
      <h2 class="text-xl font-bold tracking-tight" style="color: #031a60">
        Rent Transactions
      </h2>
      <p class="text-sm mt-0.5" style="color: #a8adc1">
        Payment history and month-by-month coverage
      </p>
      <span
